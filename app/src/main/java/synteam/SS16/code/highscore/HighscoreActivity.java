...
import synteam.SS16.code.loadscreens.highscoreLoadscreen_zeit;
...
public class HighscoreActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(synteam.SS16.code.synword.R.layout.highscore);
        getSupportActionBar().hide();

        modus = (Button) findViewById(synteam.SS16.code.synword.R.id.timeButton);
