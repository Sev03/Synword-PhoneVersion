package synteam.SS16.code.gamescreens_time;
 ...
 */
public class ts4 extends ActionBarActivity {
    public int points;
    public int round;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(synteam.SS16.code.synword.R.layout.timescreen);
        ...
        intervallBar = (ProgressBar) findViewById(synteam.SS16.code.synword.R.id.intervallBar);
        ...
        cdTimer = new CountDownTimer(15400, 1000) {
            ...
            public void onFinish() {
                Intent intent = new Intent(ts4.this, ts5.class);
