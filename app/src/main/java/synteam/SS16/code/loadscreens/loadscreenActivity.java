package synteam.SS16.code.loadscreens;
...
import synteam.SS16.code.gamescreens.gamescreenActivity;
...
public class loadscreenActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(synteam.SS16.code.synword.R.layout.loadscreen);
        getSupportActionBar().hide();
        task.execute();
        Intent intent = getIntent();
        sprache = intent.getExtras().getString("sprache");
        spinner = (ProgressBar)findViewById(synteam.SS16.code.synword.R.id.progressBar1);
