...
public class pophighscore extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(synteam.SS16.code.synword.R.layout.popuphighscore);
        ...
        TextView punkte = (TextView) this.findViewById(synteam.SS16.code.synword.R.id.txtPunkte);
        punkte.setText("" + points);

        tempusername = (EditText)findViewById(synteam.SS16.code.synword.R.id.editText);
...
//            super.onPostExecute(result);
    ...
    public void onDismiss(View view) {
        ...
        if (tempusername.getText().toString().contains(" ")) {
            tempusername.setError(getText(synteam.SS16.code.synword.R.string.hserror));
        } else if (tempusername.length() == 0){
            tempusername.setError(getText(synteam.SS16.code.synword.R.string.hserror2));
        }else {
